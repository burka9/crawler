...
class ReporterItem(Item):
  # meta data
	...
	article_timestamp = Field(output_processor=TakeFirst())
	...
	author = Field(input_processor=MapCompose(remove_tags, strip_and_remove_comma), output_processor=TakeFirst(), default="")
